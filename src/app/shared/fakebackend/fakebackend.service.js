...
var FakeBackendInterceptor = /** @class */ (function () {
    ...
    FakeBackendInterceptor.prototype.intercept = function (request, next) {
        ...
        function getDocument() {
            ...
            for (var index = 0; index < dbDocuments.length; index++) {
                var element = dbDocuments[index];
                if (element.id === docID) {
                    return ok(docID);
                }
            }
        ...
        function docMap() {
            ...
            for (var index = 0; index < mapDocument.length; index++) {
                var element = mapDocument[index];
        ...
        function docXY() {
            var filter = body.filter;
            for (var index = 0; index < xyDocument.length; index++) {
                var element = xyDocument[index];
        ...
        function docTimeline() {
            var filter = body.filter;
            for (var index = 0; index < timelineDocument.length; index++) {
                var element = timelineDocument[index];
                if (element.damage_type.includes(filter)) {
                    return ok(filter);
                }
                else if (element.incident_date == filter) {
